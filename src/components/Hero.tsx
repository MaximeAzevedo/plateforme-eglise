          ...
          <div className="grid grid-cols-2 gap-6">
            {categories.map((category, index) => (
              <button
                ...
                className="bg-culteo-blanc-pur rounded-culteo shadow-culteo-soft border border-gray-100 p-8 hover:shadow-culteo-medium transition-all duration-300 group text-center"
              >
                {/* Icône */}
                <div className="w-16 h-16 bg-culteo-blanc-coquille rounded-culteo flex items-center justify-center mx-auto mb-4 group-hover:bg-white transition-colors duration-300">
                  <category.icon 
                    className="w-8 h-8 text-culteo-vert-esperance" 
                    strokeWidth={1.5}
                    style={{ strokeLinecap: 'round', strokeLinejoin: 'round' }}
                  />
                </div>
